...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="max-w-sm bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden flex flex-col group">
