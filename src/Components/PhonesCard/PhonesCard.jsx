     ...
     {/* /* Premium White/Light Card Container */ }
            <div className="relative w-full max-w-sm rounded-3xl bg-white border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden group transition-all duration-300 hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:-translate-y-1">
                ...
                <div className="relative h-64 overflow-hidden bg-slate-50">
                    ...
                    {/* Availability Badge */}
                    <span className={`absolute top-4 right-4 px-3 py-1 text-xs font-semibold tracking-wide uppercase rounded-full backdrop-blur-md border ${is_available
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <button
                            ...
                            className={`px-5 py-2.5 font-semibold text-sm rounded-xl shadow-md transition-all duration-200 focus:outline-none ${is_available
